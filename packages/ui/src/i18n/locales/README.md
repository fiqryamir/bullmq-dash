...
Keys bullmq-dash shares with bull-board keep bull-board's translations;
bullmq-dash-specific keys are English here and in every locale until they are
translated (i18next falls back to en-US for anything missing).
